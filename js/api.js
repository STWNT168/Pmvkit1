const Api = (() => {
  ...
  return {
    ...
    getOwnPmvDashboard: d =>
      request("GET", "getOwnPmvDashboard", { date: d }),

    getAdminPmvDashboard: d =>
      request("GET", "getAdminPmvDashboard", { date: d }),
    ...
    deleteOwnPmvReport: (date) =>
      request("POST", "deleteOwnPmvReport", {
        date
      })
  };
})();
